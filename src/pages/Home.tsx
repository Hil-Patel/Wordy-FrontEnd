...
const Home = ({ setButtonClick }) => {
  ...
  return (
    <>
      <Navbar />
      <div className="flex flex-col bg-gray-100 justify-center items-center dark:bg-gray-700 h-[91.9vh]">
        <div className="shadow-lg bg-blue-100 dark:bg-gray-800 border border-gray-500 dark:border-gray-800 text-black dark:text-white p-6 max-w-md rounded-lg ">
          ...
          <div className="flex items-center gap-5 mt-10">
            ...
            <div className="flex items-center ">
              <button
                ...
                className="text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-lg text-sm px-5 py-1 me-5  dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700"
              >
                Sign Up
              </button>
              <button
                ...
                className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-1 me-2  dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
              >
                Log In
              </button>
            </div>
