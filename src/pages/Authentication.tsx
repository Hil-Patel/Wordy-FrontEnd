  ...
  return (
    <div className='flex flex-col h-screen dark:bg-gray-700 text-black dark:text-white transition-colors duration-500'>
      ...
      <div className='w-full flex-grow flex justify-center items-center'>
        <div className='w-2/3 h-5/6 bg-blue-100 dark:bg-gray-800 flex relative'><AuthenticationLogin setOpenPage={setOpenPage} setToken={setToken} token={token}/><AuthenticationSignUp setOpenPage={setOpenPage}/><img src={image} alt="" className={`absolute object-fit w-1/2 h-full ${openPage === "Login" ? "left-1/2" : "left-0"} transition-all duration-300 ease-in-out`}
        /></div>
